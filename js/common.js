...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list > div').each(function(index, element) {
			html = '<div class="row">';
			html += '<div class="left-block col-xs-12 col-sm-4 col-md-4"><div class="image">' + $(element).find('.left-block .image').html() + '</div></div>';
			html += '<div class="right-block col-xs-12 col-sm-8 col-md-8"><div class="caption">';
				...
				html += '<div class="cart">' + $(element).find('.left-block .cart').html() + '</div>';
		...
		$('.product-grid > div').each(function(index, element) {
			...
			html += '<div class="image">' + $(element).find('.left-block .image').html() + '</div>';
			...
			html += '<div class="right-block"><div class="caption">';
				...
				html += ' <p class="description">' + $(element).find('.description').html() + '</p>';
				html += '<div class="actions"><div class="button-group"><div class="add-to-links">' + $(element).find('.button-group .add-to-links').html() + '</div></div></div>';
			html += '</div></div></div>';
			$(element).html(html);
		});
